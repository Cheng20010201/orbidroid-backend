...
public class BookingController extends EntityController {
    ...
    // FIXME token system + status code returned not correct
    ...
    public ResponseEntity getHistoryByStuEmail(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified student email " + stuEmail + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByStuContact(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified student contact " + stuContact + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByStuName(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified student name " + stuName + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByDocNum(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified doctor number " + docNum + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByDocEmail(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified doctor email " + docEmail.toLowerCase() + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByDocContact(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified doctor contact number " + docContact + " found.");
        }
    }
    ...
    public ResponseEntity getHistoryByDocName(
        ...
        if (!foundBookings.isEmpty()) {
            ...
            return ResponseEntity.status(404).body("No history booking with specified doctor name " + docName + " found.");
        }
    }
